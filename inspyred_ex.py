...
##Goal: create polygon of n vertices that maximizes area
...
#evaluator function. returns areas of each polygon
...
def polygon_observer(population,num_generations,num_evaluations,args):
    try:
        ...
        args['canvas'] = canvas
    #determine best polygon in population
